...
file_names<-c('../data/prolificNS_mostrecent.rdata',
              '../data/prolificNS_mostrecent.boost.rdata',
              '../data/prolificNS_mostlikely.rdata',
              '../data/prolificNS_mostlikely.boost.rdata',    
              '../data/prolificNS_morelikely.rdata',
              '../data/prolificNS_morelikely.boost.rdata',
              '../data/prolificNS_morelikely_boost_prune.rdata',
              '../data/prolificNS_morelikely_prune.rdata',
              '../data/prolificNS_morelikely_adaptbetween_boost.rdata',
              '../data/prolificNS_morelikely_adaptbetween.rdata')
...
for (i in 1:nrow(mod_preds))
{
  for (mod_num in 1:length(mod_names))
  {
    if (!mod_preds[[mod_names[mod_num]]][i]%in%c(NA,0))
    {
...
resave(file='../data/prolific_mf_results.rdata', mod_preds)

head(mod_preds)
load('../data/prolific_data.rdata')
load('../data/prolific_mf_results.rdata')
upis<-as.character(df.sw$upi)
...
#save(file='../data/prolific_mf_results.rdata', mod_preds, res)
