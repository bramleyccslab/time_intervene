...
save(file='../data/prolificNS_mostrecent.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_mostrecent.boost.rdata', belief_trajectories, belief_reports, delay_stores)
...
for (pptix in 1:nrow(df.sw))
{
  ...
  for (ttix in 1:12)
  {
    ...
    events<-filter(df.ev, ppt==pptix, trial_type==ttix, time>0) %>%
      select(time, location, type) %>% arrange(time)
...
save(file='../data/prolificNS_mostlikely.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_mostlikely.boost.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_morelikely.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_morelikely.boost.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_morelikely_adaptbetween.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_morelikely_adaptbetween_boost.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_morelikely_prune.rdata', belief_trajectories, belief_reports, delay_stores)
...
save(file='../data/prolificNS_morelikely_boost_prune.rdata', belief_trajectories, belief_reports, delay_stores)
